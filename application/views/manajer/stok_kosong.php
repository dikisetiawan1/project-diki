...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-4">
            <form class="d-flex" action="<?= base_url('manajer/stokbarang'); ?>" method="post">
            ...
            foreach ($stok_kosong as $s) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= base_url('manajer/stokbarang/details/' . $s['id_barang']) ?>" class="btn btn-success" data-placement="top" title="Detail data"><i class="fa fa-fw fa-info-circle"></i></i>
                    </td>
