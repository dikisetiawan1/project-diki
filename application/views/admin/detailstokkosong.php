            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/stokbarang') ?>">Data</a></li>
        ...
        <div class="card mx-auto  shadow d-flex align-items-center " style="height: 60%; width:45%; ">
            <div class="row">
                <div class="col-4 mt-4">
                    ...
                    <a href="<?= base_url('admin/stokbarang') ?>" class="me-4 ">Back<i class="fa fa-fw fa-reply text-gray-300 "></i></a>
                </div>
